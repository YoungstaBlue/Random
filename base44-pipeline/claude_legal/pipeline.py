"""ClaudePipeline — the single orchestrator that wires every module together.
...
log = logging.getLogger("claude_legal.pipeline")
...
class ClaudePipeline:
    ...
    # ------------------------------------------------------------------ #
    def index_corpus(self, docs: Sequence[RawDocument]) -> "ClaudePipeline":
