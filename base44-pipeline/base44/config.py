"""Central, env-driven configuration for the base44 pipeline.
...
environment variables prefixed ``BASE44_`` (see ``.env.example``).
"""
...
class Settings(BaseSettings):
    ...
    local_db_path: Path = Path("./base44_data/base44.db")
    backup_dir: Path = Path("./base44_data/backups")
